...
import Fir from '../artifacts/contracts/DiFir.sol/Fir.json'
...
export default function Detail({Data, DonationsData}) {
  ...
  const DonateFunds = async () => {
    try {
      ...
      const contract = new ethers.Contract(Data.address, Fir.abi, signer);
...
export async function getStaticPaths() {
  ...
  return {
    paths: AllCampaigns.map((e) => ({
        params: {
          address: e.args.firAddress.toString(),
        }
    })),
    fallback: "blocking"
  }
